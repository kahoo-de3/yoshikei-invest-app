...
st.set_page_config(
    page_title="インデックス投資ダッシュボード byよしけい",
...
st.title("📈 インデックス投資ダッシュボード　byよしけい")
...
# ---- 投資初心者向け: ファンドの中身（組入銘柄・セクター構成） ----
st.subheader("🔰 投資初心者向け：ファンドの中身を見てみよう")
st.caption(
...
st.caption(
    "🛡️ **S&P500 が不調なときに資金が向かいやすい先**（ディフェンシブ）。"
